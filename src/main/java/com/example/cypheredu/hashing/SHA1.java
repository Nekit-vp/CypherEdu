...
@Component("sha1")
public class SHA1 implements Hashing {
    ...
    public static void main(String[] args) {
        ...
        SHA1 sha1 = new SHA1();
        System.out.println(sha1.getHash(word));
    ...
    public static String calculateMod(String word, String binary) {
        ...
        String result = createMessageLength(binary, onePadded, binaryZeros, endBitLength); //creates the 512 bit message
        return result;
    }
    ...
    public String getHash(String text) {
        ...
        return calculateMod(text, binary);
    }
}